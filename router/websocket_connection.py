...
#             # Update location and notify admins in real-time
...
#             elif action == "get_all":
#                 all_locations = manager.get_all_staff_locations(company_id)
#                 await websocket.send_json({
#                     "status": "success",
#                     "total_online_staff": len(all_locations),
...
#                 await websocket.send_json({
#                     "status": "error",
#                     "message": "Invalid action. Use 'get_one' or 'get_all'."
#                 })
